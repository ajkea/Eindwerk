            ...
            <div class="form--crud-section">
              <div class="input-range">
                <label for="shooting">
                  ...
                  <input type="range" name="shooting" id="shooting" min="0" max="10" value="{{ $player->playerskill->shooting }}" oninput="shootingOut.value = shooting.value">
                </label>
              ...
              <div class="input-range">
                <label for="defending">
                  ...
                  <input type="range" name="defending" id="defending" min="0" max="10" value="{{ $player->playerskill->defending }}" oninput="defendingOut.value = defending.value">
                </label>
              ...
              <div class="input-range">
                <label for="speed">
                  ...
                  <input type="range" name="speed" id="speed" min="0" max="40" value="{{ $player->playerskill->speed }}" oninput="speedOut.value = speed.value">
                </label>
              ...
              <div class="input-range">
                <label for="stamina">
                  ...
                  <input type="range" name="stamina" id="stamina" min="0" max="10" value="{{ $player->playerskill->stamina }}" oninput="staminaOut.value = stamina.value">
                </label>
              ...
              <div class="input-range">
                <label for="dribbling">
                  ...
                  <input type="range" name="dribbling" id="dribbling" min="0" max="10" value="{{ $player->playerskill->dribbling }}" oninput="dribblingOut.value = dribbling.value">
                </label>
              </div>
              <div class="input-range">
                <label for="height">
