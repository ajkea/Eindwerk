...
Vue.component('task-list', __webpack_require__(11));
...
Component.options.__file = "resources/assets/js/components/TaskListComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5de15a53", Component.options)
  } else {
    hotAPI.reload("data-v-5de15a53", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        createTask: function createTask() {
            ...
            axios.post('tasks', this.task).then(function (res) {
                _this2.task.body = '';
                _this2.edit = false;
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _c(
      ...
      [
        _vm.list.length === 0
          ? _c("li", [_vm._v("There are no tasks")])
          : _vm._e(),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5de15a53", module.exports)
  }
}
